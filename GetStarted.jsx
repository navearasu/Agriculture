  ...
  return (
    <div className="get-started-page">
      <header className="get-started-header">
        <h1>Get Started with Harvest Haven</h1>
      ...
      <section className="get-started-introduction">
        <h2>Introduction</h2>
        <p>
        Welcome to Harvest Haven, your partner in modern agriculture. We offer a comprehensive suite of tools and resources designed to boost
      ...
      <section className="get-started-action">
        ...
        <p>Sign up for Harvest Haven today and start revolutionizing your agricultural operations.</p>
        <Link to="/register">
